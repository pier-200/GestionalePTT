...
**App online:** https://pier-200.github.io/GestionalePTT/ (modalità dimostrativa con situazione esempio).
...
| Compliance Report 4.1 / 4.2 / 4.3 con esito complessivo, stampa PDF | proprio | tutti | tutti |
...
|---|---|---|---|
| `demo` (attuale) | nel browser di chi apre l'app, partendo dalla situazione esempio | applicati dall'app | tra schede dello stesso browser |
| `supabase` | database PostgreSQL centrale (Supabase) | **dal database** (Row Level Security) | in tempo reale |
...
Profili pronti nella pagina di accesso (modalità demo): Training Manager, due istruttori e sei frequentatori a diversi
...
(i documenti ufficiali non sono inclusi nella repository pubblica).
